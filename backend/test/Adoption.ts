...
describe("Adoption", function () {
    ...
    it("Should adopt a pet", async function () {
        ...
        expect(await adoption.getAdopter(1)).to.equal(addr1.getAddress());
    });
    ...
    it("Should retrieve all adopters", async function () {
        ...
        expect(adopters[1]).to.equal(addr1.getAddress());
        expect(adopters[2]).to.equal(addr2.getAddress());
    });
    ...
    it("Should transfer adoption to another address", async function () {
        ...
        expect(await adoption.getAdopter(1)).to.equal(addr2.getAddress());
    });
